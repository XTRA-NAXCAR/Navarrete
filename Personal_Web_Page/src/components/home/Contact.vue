<template>
      ...
      <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 class="text-3xl font-bold tracking-tight text-gray-900">Escríbeme</h2>
            <p class="mt-6 text-lg leading-8 text-gray-600">¿Tienes preguntas, ideas o proyectos en mente? Estoy aquí para ayudar. Envíame un mensaje y comenzaremos a dar vida a tus ideas. Juntos, podemos explorar cómo puedo contribuir al éxito de tu proyecto. ¡Espero tu mensaje!</p>
            <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
              <div class="flex gap-x-4">
                ...
                <dd>Quito, Ecuador<br />Riobamba, Ecuador</dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678">+593 99 266 9131</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
          ...
          <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div>
                ...
                <div class="mt-2.5">
                  <input v-model="name" type="text" name="first-name" id="first-name" autocomplete="given-name" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
              <div>
                <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Apellido</label>
                <div class="mt-2.5">
                  <input v-model="last_name" type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
              </div>
            ...
            <div class="mt-8 flex justify-end">
              <button @click.prevent="action()" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Enviar Mensaje</button>
            </div>
          </div>
        </form>
      </div>
  ...
  const action =  () => {
      ...
      make_request('messages/messages_post/', 'post', {
        name: name.value,
